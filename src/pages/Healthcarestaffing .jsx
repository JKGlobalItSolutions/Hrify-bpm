...
import helth1 from '../assets/imges/staffauregment/placesupport.jpg'
import helth2 from '../assets/imges/staffauregment/helth1.jpg'
import helth3 from '../assets/imges/staffauregment/prediem.jpg'
  ...
  return (
    <div className="container my-5">
      ...
      <div className="text-center mb-5">
        <h1 className="fw-bold text-danger">Healthcare Staffing Services</h1>
        <p className="lead text-muted">
          Building stronger healthcare teams to improve patient care, streamline operations, and drive sustainable growth.
        </p>
        <Link className="btn btn-danger mt-2" to="/careers/Hiretalent">Request Staffing Solutions</Link>
      </div>
      ...
      <section className="text-center mt-5">
        ...
        <Link className="btn btn-danger btn-lg" to="/careers/Hiretalent">Apply Now</Link>
      </section>
    </div>
  );
};

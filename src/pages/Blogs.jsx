...
import Blogsimg1 from '../assets/imges/about/blog1.jpg'
import Blogsimg2 from '../assets/imges/about/blog2.jpg'
import Blogsimg3 from '../assets/imges/about/blog3.jpg'
          ...
          <div className="col-md-6 col-lg-4" key={i}>
            <div className="card h-100 border-0 shadow-sm">
              ...
              <div className="card-body d-flex flex-column">
                ...
                <Link to={post.link} className="mt-auto btn btn-outline-danger">
                  Read More
                </Link>

...
import htd from '../assets/imges/staffauregment/htd.jpg'
  ...
  return (
    <div className="container my-5">
      ...
      <div className="text-center mb-5">
        <h1 className="fw-bold text-danger">Hire-Train-Deploy Model</h1>
        <p className="lead text-muted">Introducing a new type of recruitment model.</p>
        <Link className="btn btn-danger mt-2" to='/careers/Hiretalent'>Build Your Future Team</Link>
      </div>
      ...
      <section className="mb-5 p-5  rounded-3 bg-danger-subtle">
        <div className="row align-items-center">
          <div className="col-md-4">
            ...
            <img src={htd} alt="HTD Overview" className="img-fluid rounded shadow"  style={{ width :'250px', height: "200px", objectFit: "cover" }}/>
          </div>
